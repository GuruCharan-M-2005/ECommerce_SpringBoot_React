...
const Register = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:8080/login/users/search?username=${username}&phonenumber=${phonenumber}`);
      ...
      const registerResponse = await axios.post('http://localhost:8080/login/post', {
        username: username,
        password: password,
